...
describe("Feature-Group Directive", () => {
    let map: MapComponent;
    let layer: FeatureGroupDirective;
    beforeEach(() => {
        ...
        layer = new FeatureGroupDirective({ ref: map }, {} as any, {} as any);
    });
    ...
    describe("Destroying a Feature-Group Directive", () => {
        it("should remove Feature Directive from map on destroy", () => {
            /* istanbul ignore if */
