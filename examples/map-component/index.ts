...
import { ExamplePropertyComponent } from '../property.component';
...
export class AppComponent extends ExampleAppComponentBlueprint implements AfterViewInit {
    // 2-way
...
@NgModule({
    ...
    declarations: [ AppComponent, ExamplePropertyComponent ],
...
/*
 <h3>Two-Way binded properties - Test</h3>
